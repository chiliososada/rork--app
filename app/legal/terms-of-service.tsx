      ...
      <SafeAreaView style={styles.container}>
        ...
        >
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.listItem}>2. 当社は、以下の場合には、利用登録の申請を承認しないことがあります。</Text>
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>第5条（投稿コンテンツ）</Text>
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>第6条（コンテンツの削除）</Text>
            <Text style={styles.paragraph}>
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>第7条（サービスの提供の停止等）</Text>
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>第9条（退会）</Text>
            <Text style={styles.paragraph}>
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>第10条（保証の否認および免責事項）</Text>
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>第11条（サービス内容の変更等）</Text>
            <Text style={styles.paragraph}>
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>第12条（利用規約の変更）</Text>
            <Text style={styles.paragraph}>
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>第14条（通知または連絡）</Text>
            <Text style={styles.paragraph}>
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>第15条（権利義務の譲渡の禁止）</Text>
            <Text style={styles.paragraph}>
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>第16条（準拠法・裁判管轄）</Text>
